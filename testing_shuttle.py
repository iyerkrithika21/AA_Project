...
class3 = training_data[np.where(training_label==5)[0]]
class3 = training_data[np.random.randint(low = 0,high = len(class3),size=number_of_sample)]
...
name = "shuttle_"+str(k)+"_"+str(number_of_sample)+"_"+str(z)
